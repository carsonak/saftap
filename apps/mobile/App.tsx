...
export default function App() {
    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollPadding}>
      ...
      <View style={styles.balanceCard}>
        <View style={styles.balanceHeaderRow}>
          <Text style={[styles.labelCaps, { fontFamily: getFont("DM_Sans_700Bold") }]}>
            TOTAL BALANCE
          </Text>
          <View style={styles.mainWalletBadge}>
            <View style={styles.greenDot} />
            <Text style={[styles.badgeTextSmall, { fontFamily: getFont("DM_Sans_700Bold") }]}>
              Main Wallet
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity style={styles.fundButton}>
          <Text style={[styles.fundButtonText, { fontFamily: getFont("DM_Sans_700Bold") }]}>
            FUND WALLET
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.sectionHeader}>
        ...
        <TouchableOpacity>
          <Text style={[styles.viewAll, { fontFamily: getFont("DM_Sans_700Bold") }]}>View All</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.offerCard}>
        <View style={styles.offerContent}>
          ...
          <Text style={[styles.offerSub, { fontFamily: getFont("DM_Sans_400Regular") }]}>
    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollPadding}>
      ...
      <LinearGradient colors={["#1F2937", "#111827"]} style={styles.virtualCard}>
        <View style={styles.cardLogoRow}>
          ...
          <Text style={[styles.cardType, { fontFamily: getFont("DM_Sans_700Bold") }]}>
            VIRTUAL DEBIT
          </Text>
        ...
        <View style={styles.cardBottomRow}>
          <Text style={[styles.cardHolder, { fontFamily: getFont("Syne_600SemiBold") }]}>
            ALEX RIVERA
          </Text>
      ...
      <View style={styles.cardActionRow}>
        <TouchableOpacity style={styles.cardActionButton}>
          ...
          <Text style={[styles.cardActionText, { fontFamily: getFont("DM_Sans_700Bold") }]}>
            Freeze Card
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.cardActionButton}>
      ...
      <View style={styles.limitContainer}>
        <View style={styles.limitHeader}>
          <Text style={[styles.limitTitle, { fontFamily: getFont("Syne_600SemiBold") }]}>
      ...
      <View style={styles.settingsGroup}>
        <View style={styles.settingItem}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={[styles.settingTitle, { fontFamily: getFont("DM_Sans_700Bold") }]}>
  ...
  const renderPayment = () => (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollPadding}>
      ...
      <View style={styles.sendBalanceSection}>
        <Text
          style={[styles.labelCaps, { textAlign: "center", marginBottom: 8, letterSpacing: 1.5 }]}
        >
          AVAILABLE BALANCE
        </Text>
      ...
      <View style={styles.serviceGrid}>
        <ServiceCard
          ...
          icon={<SendIcon color={theme.colors.onPrimary} size={22} />}
          active
      ...
      <View style={[styles.sectionHeader, { marginTop: 32 }]}>
        <Text
          style={[styles.sectionTitle, { fontFamily: getFont("Syne_600SemiBold"), color: "#FFF" }]}
        >
          Recent Payees
        </Text>
        <TouchableOpacity>
  ...
  const renderProfile = () => (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollPadding}>
      ...
      <View style={styles.profileHeader}>
        ...
        <Text style={[styles.profileEmail, { fontFamily: getFont("DM_Sans_400Regular") }]}>
          james.oduya@gmail.com
        </Text>
        <View style={styles.tierBadge}>
          <ShieldCheck size={14} color={theme.colors.primary} />
          <Text style={[styles.tierText, { fontFamily: getFont("DM_Sans_700Bold") }]}>
            Verified Member
          </Text>
        </View>
      </View>
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollPadding}>
        ...
        <View style={styles.formContainer}>
          <Text style={[styles.label, { fontFamily: getFont("DM_Sans_400Regular") }]}>
          ...
          <Text
            style={[styles.label, { fontFamily: getFont("DM_Sans_400Regular"), marginTop: 24 }]}
          >
            Amount (KES)
          </Text>
          <View style={styles.inputBox}>
          ...
          >
            {isProcessing ? (
              ...
              <Text style={[styles.primaryButtonText, { fontFamily: getFont("DM_Sans_700Bold") }]}>
                Make Payment
              </Text>
            )}
          </TouchableOpacity>
  ...
  const renderSuccess = () => (
    <View style={[styles.flex, styles.centered, { padding: 40 }]}>
      ...
      <Text style={[styles.successSub, { fontFamily: getFont("DM_Sans_400Regular") }]}>
        ...
        <View style={styles.bottomNav}>
          ...
          {activeTab === "payment" ? (
            <TouchableOpacity style={styles.sendButtonActive} onPress={() => navigateTo("payment")}>
              ...
              <Text style={[styles.tabLabelActive, { fontFamily: getFont("DMSans_700Bold") }]}>
                Send
              </Text>
            </TouchableOpacity>
          ) : (
...
const ActivityItem = ({ title, sub, amount, kes, type }: any) => (
  <View style={styles.listItem}>
    ...
    <View style={{ alignItems: "flex-end" }}>
      <Text
        style={[styles.listAmount, { color: type === "in" ? theme.colors.primary : "#F87171" }]}
      >
        {amount}
      </Text>
...
const styles = StyleSheet.create({
  ...
  percentBadge: {
    backgroundColor: "rgba(58, 223, 171, 0.1)",
    paddingHorizontal: 10,
    paddingVertical: 4,
    borderRadius: 20,
    marginTop: 12,
  ...
  profileAvatarLarge: {
    ...
    marginBottom: 16,
    borderWidth: 4,
    borderColor: "rgba(58, 223, 171, 0.1)",
  },
